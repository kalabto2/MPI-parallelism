...
void Graph::calculate() {
    ...
    if (proc_rank == 0) {
        ...
        get_n_subgraphs(queue, init_state, 50, 0);

#ifdef DEBUG
        cout << "SIZE: " << queue.size() << endl;
        for (auto s: queue) {
                cout << s.weight << " " << s.node_depth << " ";
                for (auto i : s.subgraph_edges)
                    cout << i;
                cout << " ";
                for (auto i: s.bipartite_nodes)
                    cout << i;
                cout << endl;
        }
#endif
...
#ifdef  DEBUG
                cout << "S" << proc_rank << ": ";
                cout << job.weight << " " << job.node_depth << " ";
                for (auto i : job.subgraph_edges)
                    cout << i;
                cout << " ";
                for (auto i: job.bipartite_nodes)
                    cout << i;
                cout << endl;
#endif
...
//                cout << "WTF again: " << init_state.size() << endl;
//                cout << init_state[0].weight << " " << init_state[0].node_depth << " ";
//                for (auto i : init_state[0].subgraph_edges)
//                    cout << i;
//                cout << " ";
//                for (auto i: init_state[0].bipartite_nodes)
//                    cout << i;
//                cout << endl;
                get_n_subgraphs(queue, init_state, 200, job.node_depth);
//                cout << "WTF size??: " << queue.size() << endl;
...
//                cout << "S" << proc_rank << ": n_states: " << queue.size() << endl;
                ...
                cout << "S" << proc_rank << ": calculated maximum: " << maximum << " in "<< duration_realtime << endl;
#endif
